...
void TankMapWidget::setDrawBonusArea(bool b)
{
    if(b != drawBonusArea)
    {
        drawBonusArea = b;
...
void TankMapWidget::paintEvent(QPaintEvent *event)
{
    ...
    case EMPTY:
        ...
        break;
    case BRICK:
        bt[0][0] = (parts[0][0] == true ? BT_BRICK : BT_EMPTY);
        bt[1][0] = (parts[1][0] == true ? BT_BRICK : BT_EMPTY);
        bt[0][1] = (parts[0][1] == true ? BT_BRICK : BT_EMPTY);
        bt[1][1] = (parts[1][1] == true ? BT_BRICK : BT_EMPTY);
        break;
    case STEEL:
        bt[0][0] = (parts[0][0] == true ? BT_STEEL : BT_EMPTY);
        bt[1][0] = (parts[1][0] == true ? BT_STEEL : BT_EMPTY);
        bt[0][1] = (parts[0][1] == true ? BT_STEEL : BT_EMPTY);
        bt[1][1] = (parts[1][1] == true ? BT_STEEL : BT_EMPTY);
        break;
    case SEA:
        bt[0][0] = (parts[0][0] == true ? BT_SEA : BT_EMPTY);
        bt[1][0] = (parts[1][0] == true ? BT_SEA : BT_EMPTY);
        bt[0][1] = (parts[0][1] == true ? BT_SEA : BT_EMPTY);
        bt[1][1] = (parts[1][1] == true ? BT_SEA : BT_EMPTY);
        break;
    case JUNGLE:
        bt[0][0] = (parts[0][0] == true ? BT_JUNGLE : BT_EMPTY);
        bt[1][0] = (parts[1][0] == true ? BT_JUNGLE : BT_EMPTY);
        bt[0][1] = (parts[0][1] == true ? BT_JUNGLE : BT_EMPTY);
        bt[1][1] = (parts[1][1] == true ? BT_JUNGLE : BT_EMPTY);
        break;
    case ICE:
        bt[0][0] = (parts[0][0] == true ? BT_ICE : BT_EMPTY);
        bt[1][0] = (parts[1][0] == true ? BT_ICE : BT_EMPTY);
        bt[0][1] = (parts[0][1] == true ? BT_ICE : BT_EMPTY);
        bt[1][1] = (parts[1][1] == true ? BT_ICE : BT_EMPTY);
        break;
    case EAGLE:
        bt[0][0] = BT_EAGLELTOP;
        bt[1][0] = BT_EAGLERTOP;
        ...
        break;
    case EDGE:
        bt[0][0] = (parts[0][0] == true ? BT_EDGE : BT_EMPTY);
        bt[1][0] = (parts[1][0] == true ? BT_EDGE : BT_EMPTY);
        bt[0][1] = (parts[0][1] == true ? BT_EDGE : BT_EMPTY);
        bt[1][1] = (parts[1][1] == true ? BT_EDGE : BT_EMPTY);
        break;
    case P1:
    ...
    if(drawBonusArea) painter.fillRect(bRect.x, bRect.y, bRect.w, bRect.h, QColor(45, 251, 255, 113));
}
